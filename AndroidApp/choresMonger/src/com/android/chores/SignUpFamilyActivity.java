...
public class SignUpFamilyActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: Check if the user is authenticated, then launch the Main menu Activity
    ...
    protected Dialog onCreateDialog(int id) {
        	...
        	new DatePickerDialog(this,
        		new DatePickerDialog.OnDateSetListener() {
        			...
        			public void onDateSet(DatePicker picker, int year, int month, int day) {
                    	SignUpFamilyActivity.this.dismissDialog(DATE_DIALOG_ID);
    	...
    	case ALERT_DIALOG_ID:
            ...
            builder.setMessage("Do you want to add members?").setTitle("Add Members?");
            builder.setNegativeButton("No",
                new DialogInterface.OnClickListener() {
 					@Override
                    public void onClick(DialogInterface dialog, int whichButton) {
                    	SignUpFamilyActivity.this.dismissDialog(ALERT_DIALOG_ID);
                    	startActivity(new Intent(SignUpFamilyActivity.this,MainMenuActivity.class));
                    }
                });
            builder.setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int whichButton) {
                    	SignUpFamilyActivity.this.dismissDialog(ALERT_DIALOG_ID);
                    	startActivity(new Intent(SignUpFamilyActivity.this,AddNewFamilyMember.class));
					}                	
                });
